...
/* themes/custom/mytheme/templates/content/node--article.html.twig */
class __TwigTemplate_c821298dca3fb25e06862c1fcde4a93df70de0dbd2d1cc2f708334f913388b8a extends \Twig\Template
{
...
<article";
  ...
  <section class=\"detailed-article\">
    ...
    ";
      ...
      <div>";
            // line 116
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["node"] ?? null), "field_heading", []), 0, []), "value", [])), "html", null, true);
            echo "</div>
    </h4>
    ";
        }
...
";
    ...
    {
        return "themes/custom/mytheme/templates/content/node--article.html.twig";
    }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <section class=\"detailed-article\">
    ...
    <h4 class=\"field_heading\">
      <div>{{ node.field_heading.0.value }}</div>
    </h4>
    {% endif %}
...
", "themes/custom/mytheme/templates/content/node--article.html.twig", "C:\\xampp\\htdocs\\shubham\\Drupal_8\\drupal-test2\\themes\\custom\\mytheme\\templates\\content\\node--article.html.twig");
    }
}

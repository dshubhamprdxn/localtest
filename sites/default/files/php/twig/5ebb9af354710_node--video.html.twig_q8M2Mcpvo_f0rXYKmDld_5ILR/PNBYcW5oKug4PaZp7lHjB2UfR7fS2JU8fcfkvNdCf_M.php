...
class __TwigTemplate_bc65d81df87afb3d3dd02d6d0b2683ae74e04b3e607078386ee9cf34338ce7e8 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $filters = ["clean_class" => 76, "escape" => 83, "striptags" => 133];
...
<article";
  ...
  <section class=\"detailed-video\">
    ...
    ";
      ...
      ";
            // line 116
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["node"] ?? null), "field_heading", []), "value", [])), "html", null, true);
            echo "
    </h4>
    ";
        }
    ...
    ";
        ...
        if ($this->getAttribute(($context["content"] ?? null), "body", [])) {
            // line 132
            echo "    <p class=\"field_body\">
      ";
            // line 133
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute(($context["node"] ?? null), "body", []), "value", []))), "html", null, true);
            echo " 
    </p>
    ";
        }
    ...
    ";
        ...
        <span>";
            // line 140
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["node"] ?? null), "field_author", []), 0, []), "value", [])), "html", null, true);
            echo "</span>
      </div>
    ";
        }
  ...
  <section class=\"detailed-video\">
    ...
    {% if content.field_author %}
      <div class=\"field_author\">
        <span>Posted By:</span>
        <span>{{ node.field_author.0.value }}</span>
      </div>
    {% endif %}
  </section>
</article>

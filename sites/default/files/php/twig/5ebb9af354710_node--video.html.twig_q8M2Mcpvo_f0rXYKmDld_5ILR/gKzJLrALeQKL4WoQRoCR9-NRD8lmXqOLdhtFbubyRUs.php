...
<article";
  ...
  <section class=\"detailed-video\">
    ...
    ";
      ...
      ";
            // line 116
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed($this->getAttribute(($context["content"] ?? null), "field_heading", []))), "html", null, true);
            echo "
    </h4>
    ";
        }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <section class=\"detailed-video\">
    ...
    <h4 class=\"field_heading\">
      {{ content.field_heading|striptags }}
    </h4>
    {% endif %}

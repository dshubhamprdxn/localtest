...
<article";
  ...
  <section class=\"detailed-video\">
    ...
    ";
      ...
      ";
            // line 116
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["node"] ?? null), "field_heading", []), 0, []), "value", []))), "html", null, true);
            echo "
    </h4>
    ";
        }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <section class=\"detailed-video\">
    ...
    <h4 class=\"field_heading\">
      {{ node.field_heading.0.value|striptags }}
    </h4>
    {% endif %}

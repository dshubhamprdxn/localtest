...
<article";
  ...
  <section class=\"detailed-video\">
    ";
        ...
        ";
            // line 110
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["content"] ?? null), "field_video_content", []), 0, []), "value", [])), "html", null, true);
            echo "
      </div>
    ";
        }
    ...
    ";
      ...
      ";
            // line 116
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["content"] ?? null), "field_heading", []), 0, []), "value", [])), "html", null, true);
            echo "
    </h4>
    ";
        }
  ...
  <section class=\"detailed-video\">
    {% if content.field_video_content %}
      <div class=\"field_video_content\">
        {{ content.field_video_content.0.value }}
      </div>
    {% endif %}
    
    {% if content.field_heading %}
    <h4 class=\"field_heading\">
      {{ content.field_heading.0.value }}
    </h4>
    {% endif %}

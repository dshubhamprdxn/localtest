...
class __TwigTemplate_bc65d81df87afb3d3dd02d6d0b2683ae74e04b3e607078386ee9cf34338ce7e8 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $filters = ["clean_class" => 76, "escape" => 83, "striptags" => 116];
...
<article";
  ...
  <section class=\"detailed-video\">
    ";
        ...
        ";
            // line 110
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["node"] ?? null), "field_video_content", []), 0, []), "value", [])), "html", null, true);
            echo "
      </div>
    ";
        }
    ...
    ";
      ...
      ";
            // line 116
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, strip_tags($this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["content"] ?? null), "field_heading", []), 0, []), "value", []))), "html", null, true);
            echo "
    </h4>
    ";
        }
  ...
  <section class=\"detailed-video\">
    {% if content.field_video_content %}
      <div class=\"field_video_content\">
        {{ node.field_video_content.0.value }}
      </div>
    {% endif %}
    
    {% if content.field_heading %}
    <h4 class=\"field_heading\">
      {{ content.field_heading.0.value|striptags }}
    </h4>
    {% endif %}
